    ...
    public function addCommentToEvent($request, $response) {
        ...
        try {
            ...
            if (isset($_FILES['commentdata'])) {
                ...
                $uploadedimg = $awsS3Url $this->awsupload($new_file_name, $file_tmp, $contentType, "event_comment_post");
        ...
        $EventPostUserId = $this->getEventPostUserId($postData['userid']);
        ...
        if (isset($postData['eventpostid'])) {
            ...
            try {
                ...
                if ($postData['posttype'] == 'image' OR $postData['posttype'] == 'video') {
                    ...
                    $contentType = $files['type'];
                    // move_uploaded_file($file_tmp, $path . $new_file_name);
                    $uploadedimg = $awsS3Url $this->awsupload($new_file_name, $file_tmp, $contentType, "event_post");
...
//                    }
                    ...
                    $uploadedimg1 = $awsS3Url $this->awsupload($imgname1, $file_tmp1, $contentType1, "promotionalimages");
                }
...
//                    }
                    ...
                    $uploadedimg2 = $awsS3Url $this->awsupload($imgname2, $file_tmp2, $contentType2, "promotionalimages");
                }
...
//                    }
                    ...
                    $uploadedimg3 = $awsS3Url $this->awsupload($imgname3, $file_tmp3, $contentType3, "promotionalimages");
                }
...
//        }
    ...
    public function creator_tempo_rating($eventid) {
        ...
        $event = $this->_db->table('events')
                ...
                ->where('event_id', $eventid)
                ->first();
        $event_rating = isset($event->event_rating) ? $event->event_rating : 0;
    ...
    public function last_event_rating($eventid) {
        ...
        $event = $this->_db->table('events')
                ...
                ->select('last_value')
                ->first();
        $event_rating = isset($event->last_value) ? $event->last_value : 0;
        if (isset($event_rating) and $event_rating != '') {
    ...
    public function update_event_media_like($request, $response) {
        ...
        if (count($check_post_exists) == 0) {
            ...
            if ($islike != 0) {
                ...
                $EventPostUserId = $this->getEventPostUserId($userid);
