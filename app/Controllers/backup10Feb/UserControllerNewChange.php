...
class UserController {
    ...
    public function uploadAvatar($request, $response) {
        ...
        if ($_FILES['avatar']['error'] === 0) {
            ...
            $tmp = $files['tmp_name'];
            $contentType = $files['type'];
            $uploadedimg = $awsS3Url   . $this->awsupload($certificate_newname, $tmp, $contentType, "avatar");
            ...
            try {
                ...
                if (isset($_FILES['postdata'])) {
                    ...
                    if ($filetype == 'image') {
                        ...
                        $uploadedimg = $awsS3Url  . $this->awsupload($imgname, $originalimage, $contentType, "user_post");

                        $uploadedThumbimg = $awsS3Url   . $this->awsupload($thumbImageName, $thumbpath, $thumbcontentType, "user_post_thumbs");
                        ...
                        $uploadedimg = $awsS3Url   . $this->awsupload($certificate_newname, $tmp, $contentType, "user_post");
                        $userPost->user_post_data = $uploadedimg;
            ...
            try {
                ...
                if ($eventidpos === false) {
                    ...
                    if (isset($_FILES['postdata'])) {
                        ...
                        $uploadedimg = $awsS3Url  . $this->awsupload($certificate_newname, $file_tmp, $contentType, "event_post");
    ...
    public function setPostComments($request, $response) {
        ...
        try {
            ...
            if ($postData['commenttype'] == 'image' OR $postData['commenttype'] == 'video') {
                ...
                $file_tmp = $files['tmp_name'];
                $contentType = $files['type'];
                $uploadedimg = $awsS3Url  . $this->awsupload($new_file_name, $file_tmp, $contentType, "post_comment");
    ...
    public function addCommentToPost($request, $response) {
        ...
        try {
            ...
            if (isset($_FILES['commentdata'])) {
                ...
                $contentType = $files['type'];
                $uploadedimg = $awsS3Url  . $this->awsupload($new_file_name, $file_tmp, $contentType, "comment_post");
...
//                        'isdeleted' => 1]);
    ...
    function UploadVideoThumbnail($request, $response) {
        ...
        if (isset($_FILES['videothumbnail']) && $_FILES['videothumbnail']['error'] === 0) {
            ...
            $file_tmp = $files['tmp_name'];
            $contentType = $files['type'];
            $uploadedThumbimg = $awsS3Url   . $this->awsupload("thumb_" . $imgname, $file_tmp, $contentType, "user_post_thumbs");
