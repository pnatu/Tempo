...
if (stripos($_SERVER['SCRIPT_NAME'], 'apps/phpgrid-custom-crm')) {
    define('PHPGRID_DB_HOSTNAME', 'tempodb.cetiq3nrjtaw.us-west-2.rds.amazonaws.com'); // database host name
    define('PHPGRID_DB_USERNAME', 'satempo');     // database user name
    define('PHPGRID_DB_PASSWORD', '$aTemp0db'); // database password
    define('PHPGRID_DB_NAME', 'TempoProd'); // database name
